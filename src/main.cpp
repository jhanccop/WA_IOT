...
void backgorund(){
    ...
    // print labels
    mydisp.setPrintPos(52, 2, _TEXT_);
    mydisp.print("Load");

    mydisp.setPrintPos(53, 3, _TEXT_);
    mydisp.print("Pos");

    mydisp.setPrintPos(50, 4, _TEXT_);
    mydisp.print("P Load");

    mydisp.setPrintPos(50, 5, _TEXT_);
    mydisp.print("m Load");

    mydisp.setPrintPos(50, 6, _TEXT_);
    mydisp.print("P fill");

    mydisp.setPrintPos(53, 7, _TEXT_);
    mydisp.print("SPM");

    valueOverview(12, 57, 4);
    delay(10);
    valueOverview(12, 57, 5);
    delay(10);

    valueOverview(12.54, 57, 6);
    delay(10);
    valueOverview(12.4, 57, 7);
    delay(10);
}
...
void overview(float currentLoad, float currentPos)
{
    ...
    valueOverview(currentLoad, 57, 2);
    delay(50);
    valueOverview(currentPos, 57, 3);
    delay(50);
